...
class PaymentTypesControllerTest < ActionController::TestCase
  ...
  test "should create payment_type" do
    assert_difference('PaymentType.count') do
      post :create, payment_type: { card_number: @payment_type.card_number, customer_id: @payment_type.customer_id, expiry_month: @payment_type.expiry_month, expiry_year: @payment_type.expiry_year, payment_type: @payment_type.payment_type }
    end
  ...
  test "should update payment_type" do
    patch :update, id: @payment_type, payment_type: { card_number: @payment_type.card_number, customer_id: @payment_type.customer_id, expiry_month: @payment_type.expiry_month, expiry_year: @payment_type.expiry_year, payment_type: @payment_type.payment_type }
    assert_redirected_to payment_type_path(assigns(:payment_type))
  end
