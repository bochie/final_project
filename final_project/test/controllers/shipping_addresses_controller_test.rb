...
class ShippingAddressesControllerTest < ActionController::TestCase
  ...
  test "should create shipping_address" do
    assert_difference('ShippingAddress.count') do
      post :create, shipping_address: { address: @shipping_address.address, country: @shipping_address.country, customer_id: @shipping_address.customer_id, postal_code: @shipping_address.postal_code, state_province: @shipping_address.state_province }
    end
  ...
  test "should update shipping_address" do
    patch :update, id: @shipping_address, shipping_address: { address: @shipping_address.address, country: @shipping_address.country, customer_id: @shipping_address.customer_id, postal_code: @shipping_address.postal_code, state_province: @shipping_address.state_province }
    assert_redirected_to shipping_address_path(assigns(:shipping_address))
  end
